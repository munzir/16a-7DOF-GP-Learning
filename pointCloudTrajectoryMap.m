...
title('Point Cloud of End-Effector Position (Training Trajectory)','Interpreter','latex');
view([-30 45])
...
ylabel('y-axis','Interpreter','latex');
zlabel('z-axis','Interpreter','latex');
title('Point Cloud of End-Effector Position (Testing Trajectory)','Interpreter','latex');